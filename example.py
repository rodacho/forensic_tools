...
def sysinternal():
  os.chdir(os.getcwd())
  fecha=os.popen('date /t>fecha.txt')
  hora=os.popen('time /t>hora.txt')
  procesos=os.popen('pslist>procesos.txt')
  librerias=os.popen('listdlls>librerias.txt')
  conexiones=os.popen('netstat -an>conexiones.txt')
  infosystem=os.popen('psinfo>infosystem.txt')
  eventos=os.popen('psloglist>eventos.txt')
  servicios=os.popen('psservice>servicios.txt')
  usuarios=os.popen('psloggedon>usuarios.txt')
  iparp=os.popen('arp -a>iparp.txt')
